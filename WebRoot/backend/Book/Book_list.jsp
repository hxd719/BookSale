...
<!-- jQuery -->
  <script type="text/javascript">
	...
	function go1(page) {
		window.location.href="Book_list?searchKey=<%= request.getAttribute("searchKey")==null?"":request.getAttribute("searchKey") %>&pm.pageNum="+page;
	}
	
	function delet(id) {
		if(confirm("确定要删除么？")) {
			document.getElementById("form").action="Book_delete?id="+id;
			document.getElementById("form").submit();
		}
	}
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div id="search_box"> 
			<form id="serachfrom" method="post" action="Book_list?pm.pageNum=1"> 
				<div>
		...
		<form id="form" action="Book_deletebatch" method="post" >
				<div>
          ...
          <table>
            ...
            <% List<Book> books = (List<Book>)data.getDatas(); int i = 1;
              ...
              <tr>
                ...
                <td>
					<a href="<%= book.getCover()  %>" onmouseout="document.getElementById('img<%= i %>').innerHTML='<img src='<%= book.getCover()  %>' />'" onmouseover="document.getElementById('img<%= i %>').innerHTML=''">封面</a>
				</td>
                
                
                <td>
                  <!-- Icons -->
                  <a href="Book_modify?id=<%= book.getId()%>" title="编辑"><img src="resources/images/icons/pencil.png" alt="Edit" /></a> <a href="javascript:delet(<%=book.getId()%>)" title="删除"><img src="resources/images/icons/cross.png" alt="Delete" /></a> </td>
              </tr>
