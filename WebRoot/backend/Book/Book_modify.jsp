        ...
        <div class="tab-content default-tab" id="tab2">
          <form action="Book_update" method="post">
           ...
           <div> 
            ...
            <p>
              <label>图书ISBN</label>
              <input class="text-input small-input" type="text" id="small-input" name="ISBN" value="<%= book.getISBN() %>" />
              <!-- Classes for input-notification: success, error, information, attention -->
            </p>
            
             <p>
              <label>图书名字</label>
              <input class="text-input small-input" type="text" id="small-input" name="name" value="<%= book.getName() %>" />
              <!-- Classes for input-notification: success, error, information, attention -->
            </p>
            
             <p>
              <label>图书作者</label>
              <input class="text-input small-input" type="text" id="small-input" name="author" value="<%= book.getAuthor() %>" />
              <!-- Classes for input-notification: success, error, information, attention -->
            </p>
            
            <p>
              <label>图书出版社</label>
              <input class="text-input small-input" type="text" id="small-input" name="press" value="<%= book.getPress() %>" />
              <!-- Classes for input-notification: success, error, information, attention -->
            </p>
