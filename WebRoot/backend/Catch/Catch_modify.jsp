    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab2">
          <form action="Catch/Catch_modify.jsp" method="post">
           ...
           <div> 
            <input type="hidden" id="id" name="id" value="selected" />
             ...
             <div class="bulk-actions align-left">
                  <select name="name">
                  <option value="moren" <%= s.equals("moren")?"selected":" "  %> >Choose an action...</option>
                    <option value="guojia" <%= s.equals("guojia")?"selected":" "  %>>中国国家数字图书馆</option>
                    <option value="douban" <%= s.equals("douban")?"selected":" "  %> >豆瓣网</option>
                  </select>
             </div>
            <p>
