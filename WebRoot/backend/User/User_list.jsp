...
<!-- jQuery -->
  <script type="text/javascript">
	...
	function go1(page) {
		window.location.href="User_list?searchKey=<%= request.getAttribute("searchKey")==null?"":request.getAttribute("searchKey") %>&pm.pageNum="+page;
	}
	
	function delet(id) {
		if(confirm("确定要删除么？")) {
			document.getElementById("form").action="User_delete?id1="+id;
			document.getElementById("form").submit();
		}
	}
 ...
 <div id="main-content">
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
		...
		<form id="form" action="User_deletebatch" method="post" >
				<div>
          ...
          <table>
            ...
            <% List<User> books = (List<User>)data.getDatas(); int i = 1;
      		for (Iterator iterator = books.iterator(); iterator.hasNext();) {
      			User book = (User) iterator.next();
              ...
              <tr>
                ...
                <td><%= book.getPhone()  %></td>
                <td><%= book.getName()  %></td>
                <td><%= book.getSex()==1?"男":(book.getSex()==0?"女":"保密")  %></td>
                <td><%= f.format(book.getDate())  %></td>
                <td>
