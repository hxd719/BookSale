...
<!-- jQuery -->
  <script type="text/javascript">
	...
	function go1(page) {
		window.location.href="BuyInfo_list?searchKey=<%= request.getAttribute("searchKey")==null?"":request.getAttribute("searchKey") %>&pm.pageNum="+page;
	}
	
	function delet(id) {
		if(confirm("确定要删除么？")) {
			document.getElementById("form").action="BuyInfo_delete?id="+id;
			document.getElementById("form").submit();
		}
	}
    ...
    <div class="content-box">
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <div id="search_box"> 
			<form id="serachfrom" method="post" action="BuyInfo_list?pm.pageNum=1"> 
				<div>
		...
		<form id="form" action="BuyInfo_deletebatch" method="post" >
				<div>
          ...
          <table>
            ...
            <% List<BuyInfor> books = (List<BuyInfor>)data.getDatas(); int i = 1;
      		for (Iterator iterator = books.iterator(); iterator.hasNext();) {
      			BuyInfor book = (BuyInfor) iterator.next();
